...
export class UI {
    ...
    <div class="card card-body mb-3"> 
        ...
        <div class="col-md-3">
                        ...
                        <a href="${user.htmlUrl}" target="_blank" class="btn btn-primary d-block mb-4">View Profile</a>
                      </div>
                      <div class="col-md-9">
                            <span class="badge bg-primary ">Public Repos: ${user.publicRepos}</span>
                            <span class="badge bg-light">Public Gists: ${user.publicGists}</span>
                            ...
                            <li class="list-group-item">
                                ...
                                <li class="list-group-item">Member Since: ${formatDate(user.createdAt)}</li>
